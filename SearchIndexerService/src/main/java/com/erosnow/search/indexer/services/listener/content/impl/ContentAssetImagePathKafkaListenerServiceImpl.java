...
@Service(Listener.CONTENT_ASSET_IMAGEPATH_KAFKA_LISTENER)
@Scope("prototype")
public class ContentAssetImagePathKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(ContentAssetImagePathKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public ContentAssetImagePathKafkaListenerServiceImpl() {
		super(Listener.CONTENT_ASSET_IMAGEPATH_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexContentAssetImagePaths(contentIds);
		} catch (Exception e) {
