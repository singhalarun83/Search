...
@Service(Listener.CONTENT_PRODUCT_KAFKA_LISTENER)
@Scope("prototype")
public class ContentProductKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(ContentProductKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public ContentProductKafkaListenerServiceImpl() {
		super(Listener.CONTENT_PRODUCT_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexContentProducts(contentIds);
		} catch (Exception e) {
