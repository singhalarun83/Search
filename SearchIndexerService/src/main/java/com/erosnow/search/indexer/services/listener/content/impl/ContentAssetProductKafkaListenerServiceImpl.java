...
@Service(Listener.CONTENT_ASSET_PRODUCT_KAFKA_LISTENER)
@Scope("prototype")
public class ContentAssetProductKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(ContentAssetProductKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public ContentAssetProductKafkaListenerServiceImpl() {
		super(Listener.CONTENT_ASSET_PRODUCT_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexContentAssetProducts(contentIds);
		} catch (Exception e) {
