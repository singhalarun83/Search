...
@Service(Listener.PARENT_CONTENT_KAFKA_LISTENER)
@Scope("prototype")
public class ParentContentKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(ParentContentKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public ParentContentKafkaListenerServiceImpl() {
		super(Listener.PARENT_CONTENT_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexParentContents(contentIds);
		} catch (Exception e) {
