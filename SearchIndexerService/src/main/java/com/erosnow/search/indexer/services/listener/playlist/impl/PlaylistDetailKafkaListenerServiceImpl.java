...
@Service(Listener.PLAYLIST_DETAIL_KAFKA_LISTENER)
@Scope("prototype")
public class PlaylistDetailKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(PlaylistDetailKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public PlaylistDetailKafkaListenerServiceImpl() {
		super(Listener.PLAYLIST_DETAIL_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getPlaylistIndexerService().indexPlaylistDetails(playlistIds);
		} catch (Exception e) {
