...
@Service(Listener.KEYWORD_KAFKA_LISTENER)
@Scope("prototype")
public class KeywordkafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(KeywordkafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public KeywordkafkaListenerServiceImpl() {
		super(Listener.KEYWORD_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexKeywords(contentIds);
		} catch (Exception e) {
