...
@Service(Listener.SUBTITLE_KAFKA_LISTENER)
@Scope("prototype")
public class SubtitleKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(SubtitleKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public SubtitleKafkaListenerServiceImpl() {
		super(Listener.SUBTITLE_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexSubtitles(contentIds);
		} catch (Exception e) {
