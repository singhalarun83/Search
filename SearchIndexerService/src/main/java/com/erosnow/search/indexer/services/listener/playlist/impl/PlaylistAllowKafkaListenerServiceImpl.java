...
@Service(Listener.PLAYLIST_ALLOW_KAFKA_LISTENER)
@Scope("prototype")
public class PlaylistAllowKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(PlaylistAllowKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public PlaylistAllowKafkaListenerServiceImpl() {
		super(Listener.PLAYLIST_ALLOW_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getPlaylistIndexerService().indexPlaylistAllows(playlistIds);
		} catch (Exception e) {
