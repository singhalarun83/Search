...
@Service(Listener.BASIC_COUNT_KAFKA_LISTENER)
@Scope("prototype")
public class BasicCountKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(BasicCountKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public BasicCountKafkaListenerServiceImpl() {
		super(Listener.BASIC_COUNT_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexBasicCounts(contentIds);
		} catch (Exception e) {
