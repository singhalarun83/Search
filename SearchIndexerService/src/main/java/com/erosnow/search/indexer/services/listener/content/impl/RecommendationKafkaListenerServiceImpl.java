...
@Service(Listener.RECOMMENDATION_KAFKA_LISTENER)
@Scope("prototype")
public class RecommendationKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(RecommendationKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public RecommendationKafkaListenerServiceImpl() {
		super(Listener.RECOMMENDATION_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexRecommendations(contentIds);
		} catch (Exception e) {
