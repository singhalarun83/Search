...
@Service(Listener.TOTAL_COUNT_KAFKA_LISTENER)
@Scope("prototype")
public class TotalCountKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(TotalCountKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public TotalCountKafkaListenerServiceImpl() {
		super(Listener.TOTAL_COUNT_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexTotalCounts(contentIds);
		} catch (Exception e) {
