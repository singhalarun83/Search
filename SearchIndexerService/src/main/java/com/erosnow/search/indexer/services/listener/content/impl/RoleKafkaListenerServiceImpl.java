...
@Service(Listener.ROLE_KAFKA_LISTENER)
@Scope("prototype")
public class RoleKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(RoleKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public RoleKafkaListenerServiceImpl() {
		super(Listener.ROLE_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexRoles(contentIds);
		} catch (Exception e) {
