...
@Service(Listener.GENRE_KAFKA_LISTENER)
@Scope("prototype")
public class GenreKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(GenreKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public GenreKafkaListenerServiceImpl() {
		super(Listener.GENRE_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexGenres(contentIds);
		} catch (Exception e) {
