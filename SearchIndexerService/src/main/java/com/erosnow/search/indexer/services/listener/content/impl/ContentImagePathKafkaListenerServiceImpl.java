...
@Service(Listener.CONTENT_IMAGEPATH_KAFKA_LISTENER)
@Scope("prototype")
public class ContentImagePathKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(ContentImagePathKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public ContentImagePathKafkaListenerServiceImpl() {
		super(Listener.CONTENT_IMAGEPATH_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexContentImagePaths(contentIds);
		} catch (Exception e) {
