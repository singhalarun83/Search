...
@Service(Listener.CONTENT_ALL_KAFKA_LISTENER)
@Scope("prototype")
public class ContentAllKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(ContentAllKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public ContentAllKafkaListenerServiceImpl() {
		super(Listener.CONTENT_ALL_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexContentAll(contentIds);
		} catch (Exception e) {
