...
@Service(Listener.PRODUCT_MOVIES_KAFKA_LISTENER)
@Scope("prototype")
public class ProductMoviesKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(ProductMoviesKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public ProductMoviesKafkaListenerServiceImpl() {
		super(Listener.PRODUCT_MOVIES_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexProductMovies(contentIds);
		} catch (Exception e) {
