...
@Service(Listener.PREMIUM_COUNT_KAFKA_LISTENER)
@Scope("prototype")
public class PremiumCountKafkaListenerServiceImpl extends AbstractKafkaListenerServiceImpl {

	private static final Logger LOG = LoggerFactory.getLogger(PremiumCountKafkaListenerServiceImpl.class);

	protected Set<String> ids = new HashSet<String>();

	public PremiumCountKafkaListenerServiceImpl() {
		super(Listener.PREMIUM_COUNT_KAFKA_LISTENER);
	}
	...
	public synchronized void index() {
		...
		try {
			...
			getContentIndexerService().indexPreminumCounts(contentIds);
		} catch (Exception e) {
